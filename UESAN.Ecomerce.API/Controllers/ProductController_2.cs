...
namespace UESAN.Ecomerce.API.Controllers
{
    ...
    [ApiController]
    public class ProductController_2 : ControllerBase
    {
        private readonly IProductServices _productServices;

        public ProductController_2(IProductServices productServices)
        {
        ...
        public async Task<IActionResult> UpdateProduct(int id, [FromBody] ProductDTO dto)
        {
            ...
            var existing = await _productServices.GetProductById(id);
